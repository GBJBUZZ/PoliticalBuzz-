...
export default function page() {
  return (
    <main className="space-y-8">
      {" "}
      <section className="grid grid-cols-1 md:grid-cols-2 gap-8 bg-[url('/assets/Agriculture/agroculture-bg.png')] relative overflow-y-hidden min-h-[80dvh]">
        <div className="px-8 md:px-20 py-10 md:py-20 space-y-8 place-content-center">
          {/* <h5 className="text-[2rem] ">Political Journey</h5> */}
          <h1 className="text-white">Agriculture</h1>
        </div>
      </section>

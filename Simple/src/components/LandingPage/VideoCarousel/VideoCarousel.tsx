...
export default function VideoCarousel() {
  ...
  const arr = [
    <iframe
      key={2001}
      src="https://www.youtube.com/watch?v=YywkftXAP7o"
      title="PM Modi Speech on Development"
    ...
    <iframe
      key={2002}
      src="https://www.youtube.com/watch?v=YywkftXAP7o"
      title="PM Modi Inspirational Speech"
      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
      referrerPolicy="strict-origin-when-cross-origin"
      className="w-full h-full"
    ></iframe>,
    <iframe
      key={2003}
      src="https://www.youtube.com/watch?v=YywkftXAP7o"
      title="PM Modi on Good Governance"
      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
      referrerPolicy="strict-origin-when-cross-origin"
      className="w-full h-full"
    ></iframe>,
    ...
    <iframe
      key={2005}
      src="https://www.youtube.com/watch?v=YywkftXAP7o"
      title="PM Modi Leadership Speech"
      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
      referrerPolicy="strict-origin-when-cross-origin"
      className="w-full h-full"
    ></iframe>,
    <iframe
      key={2006}
      src="https://www.youtube.com/watch?v=YywkftXAP7o"
      title="PM Modi Vision for India"
      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
      referrerPolicy="strict-origin-when-cross-origin"
      className="w-full h-full"
    ></iframe>,
    <iframe
      key={2007}
      src="https://www.youtube.com/watch?v=YywkftXAP7o"
      title="PM Modi on Public Service"
      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
      referrerPolicy="strict-origin-when-cross-origin"
      className="w-full h-full"
    ></iframe>,
    <iframe
      key={2008}
      src="https://www.youtube.com/watch?v=YywkftXAP7o"
      title="PM Modi Community Development"
      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
      referrerPolicy="strict-origin-when-cross-origin"
      className="w-full h-full"
    ></iframe>,
    <iframe
      key={2009}
      src="https://www.youtube.com/watch?v=YywkftXAP7o"
      title="PM Modi Inspiring Leadership"
      allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
      referrerPolicy="strict-origin-when-cross-origin"
      className="w-full h-full"
    ></iframe>,
